...
5. In the opened dialog search **ai.api**, choose **ai.api:sdk:1.7.6** item and append `@aar` to the end of library name (see image) then click OK.<br/> ![Add dependency](docs/images/Dependencies2.png)
